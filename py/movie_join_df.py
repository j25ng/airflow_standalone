...
df1 = spark.read.parquet(f"/home/j25ng/data/movie/repartition/load_dt={LOAD_DT}")
df1.show()
...
df_j.write.partitionBy("load_dt", "multiMovieYn", "repNationCd").parquet("/home/j25ng/data/movie/hive/")
